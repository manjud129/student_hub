        ...
        <div class="card">
            <form action="/simpan" method="post">
                <div class="field">
                    ...
                    <input id="title" type="text" name="title" placeholder="Judul Beasiswa" required />
                </div>

                <div class="field">
                    <label for="deadline">Deadline</label>
                    <input id="deadline" type="text" name="deadline" placeholder="Contoh: 12 Des 2026" />
                </div>

                <div class="field">
                    <label for="source">Sumber</label>
                    <input id="source" type="text" name="source" placeholder="Nama institusi / sumber" />
                </div>
