    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        @media (max-width: 860px){
            ...
            .row-title{color:var(--muted); font-size:12px}
        }
    </style>
</head>
<body>
    <div class="wrap">
        <div class="top">
            <div>
                <h2>Program Pending</h2>
                <p>Tinjau beasiswa yang menunggu persetujuan admin.</p>
            </div>
        ...
        <div class="card">
            <?php if(empty($programs)): ?>
                <div class="empty">Tidak ada program pending.</div>
            <?php else: ?>
                <table>
                    <caption style="caption-side:bottom; display:none;">Daftar program pending</caption>
                    <thead>
                        <tr>
                            <th>Judul</th>
                            <th>Deadline</th>
